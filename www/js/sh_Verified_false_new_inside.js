...
// /alert(oneemp);
  $('.ssnew').append('<li><a href="http://fourthforce.in/verify/watchguardlive/uploads/'+oneemp+'"><img src="http://fourthforce.in/verify/watchguardlive/uploads/'+oneemp+'" style="height: 100%;width:100%" ></a></li>');
...
//$('.document_imag_inproone_newbb').append('<img src="http://fourthforce.in/verify/uploads/'+one+'" alt="Band"  class="rondell-item-image rondell-item-resizeable">');

   $('.newww').append('<li><a href="http://fourthforce.in/verify/watchguardlive/uploads/'+one+'"><img src="http://fourthforce.in/verify/watchguardlive/uploads/'+one+'" style="height: 100%;width:100%" ></a></li>');
...
if ( k == 1){
  var one=oneemploy[k];
//alert(oneo+'two');
//$('.document_imag_inproone_newdd').append('<img src="http://fourthforce.in/verify/uploads/'+oneo+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
...
if ( k == 2){
  var one=oneemploy[k];
//alert(oneoo+'3');
//$('.document_imag_inproone_newcc').append('<img src="http://fourthforce.in/verify/uploads/'+oneoo+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
   $('.newww').append('<li><a href="http://fourthforce.in/verify/watchguardlive/uploads/'+one+'"><img src="http://fourthforce.in/verify/watchguardlive/uploads/'+one+'" style="height: 100%;width:100%" ></a></li>');
...
if ( k == 3){
  var one=oneemploy[k];
// alert(oneooo+'4');
//$('.document_imag_inproone_newaa').append('<img src="http://fourthforce.in/verify/uploads/'+oneooo+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
   $('.newww').append('<li><a href="http://fourthforce.in/verify/watchguardlive/uploads/'+one+'"><img src="http://fourthforce.in/verify/watchguardlive/uploads/'+one+'" style="height: 100%;width:100%" ></a></li>');
...
if ( k == 4){
  var one=oneemploy[k];
// alert(oner+'5');
//$('.document_imag_inproone_newee').append('<img src="http://fourthforce.in/verify/uploads/'+oner+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
   $('.newww').append('<li><a href="http://fourthforce.in/verify/watchguardlive/uploads/'+one+'"><img src="http://fourthforce.in/verify/watchguardlive/uploads/'+one+'" style="height: 100%;width:100%" ></a></li>');
...
// alert(oner+'6');
//$('.document_imag_inproone_newff').append('<img src="http://fourthforce.in/verify/uploads/'+oner+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
   $('.newww').append('<li><a href="http://fourthforce.in/verify/watchguardlive/uploads/'+one+'"><img src="http://fourthforce.in/verify/watchguardlive/uploads/'+one+'" style="height: 100%;width:100%" ></a></li>');
...
//$('.s2').append('<li><a href="http://fourthforce.in/verify/watchguardlive/uploads/'+one+'"><img src="http://fourthforce.in/verify/watchguardlive/uploads/'+one+'" style="height: 100%;width:100%" ></a></li>');
   $('.newww').append('<li><a href="http://fourthforce.in/verify/watchguardlive/uploads/'+one+'"><img src="http://fourthforce.in/verify/watchguardlive/uploads/'+one+'" style="height: 100%;width:100%" ></a></li>');
...
//alert(oneemp);
  $('.ssnew').append('<li><a href="http://fourthforce.in/verify/watchguardlive/documents/addressid/'+oneemp+'"><img src="http://fourthforce.in/verify/watchguardlive/documents/addressid/'+oneemp+'" style="height: 100%;width:100%" ></a></li>');
...
$('.document_imag_inproone_newbb').append('<img src="http://fourthforce.in/verify/documents/addressid/'+one+'" alt="Band"  class="rondell-item-image rondell-item-resizeable">');
}
...
//alert(oneo+'two');
$('.document_imag_inproone_newdd').append('<img src="http://fourthforce.in/verify/documents/addressid/'+oneo+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
...
//alert(oneoo+'3');
$('.document_imag_inproone_newcc').append('<img src="http://fourthforce.in/verify/documents/addressid/'+oneoo+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
...
//alert(oneooo+'4');
$('.document_imag_inproone_newdaa').append('<img src="http://fourthforce.in/verify/documents/addressid/'+oneooo+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');

}
if ( j == 4){
  var oner=oneaddress[j];
// alert(oner+'5');
$('.document_imag_inproone_newee').append('<img src="http://fourthforce.in/verify/documents/addressid/'+oner+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
...
if ( j == 5){
  var oner=oneaddress[j];
//alert(oner+'6');
$('.document_imag_inproone_newff').append('<img src="http://fourthforce.in/verify/documents/addressid/'+oner+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
...
if(x !== 'New'){
$.ajax({url: "http://fourthforce.in/verify/slim-cor/insertbut.php?name="+name+"&verification_user_id="+verification_user_id+"&verification_for="+verification_for+"&current_address="+current_address+"&location="+location+"&state="+state+"&qualification_name="+qualification_name+"&task_name="+task_name+"&type="+type,
...
$.ajax({
  type: "POST",
  url: "http://fourthforce.in/verify/slim-cor/insertbut.php?name="+name+"&verification_user_id="+verification_user_id+"&verification_for="+verification_for+"&current_address="+current_address+"&location="+location+"&state="+state+"&qualification_name="+qualification_name+"&task_name="+task_name+"&type="+type,
