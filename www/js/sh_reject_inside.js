...
// /alert(oneemp);
  $('.ssnewinpcq').append('<li><a href="http://fourthforce.in/verify/watchguardlive/uploads/'+oneemp+'"><img src="http://fourthforce.in/verify/watchguardlive/uploads/'+oneemp+'" style="height: 100%;width:100%" ></a></li>');
...
//alert(oneemp);
  $('.ssnewinpcq').append('<li><a href="http://fourthforce.in/verify/watchguardlive/documents/addressid/'+oneemp+'"><img src="http://fourthforce.in/verify/watchguardlive/documents/addressid/'+oneemp+'" style="height: 100%;width:100%" ></a></li>');
...
if(x !== 'New'){
$.ajax({url: "http://fourthforce.in/verify/slim-cor/insertbutsecond.php?name="+name+"&verification_user_id="+verification_user_id+"&verification_for="+verification_for+"&current_address="+current_address+"&location="+location+"&state="+state+"&qualification_name="+qualification_name+"&task_name="+task_name+"&type="+type,
