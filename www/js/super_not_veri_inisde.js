...
// /alert(oneemp);
  $('.ssd').append('<li><a href="http://fourthforce.in/verify/watchguardlive/uploads/'+oneemp+'"><img src="http://fourthforce.in/verify/watchguardlive/uploads/'+oneemp+'" style="height: 100%;width:100%" ></a></li>');
...
//alert(one+'oneoooooooooooooooooooooooooo');
     $('.s1').append('<li><a href="http://fourthforce.in/verify/watchguardlive/uploads/'+one+'"><img src="http://fourthforce.in/verify/watchguardlive/uploads/'+one+'"  style="height: 300px;width:350px"></a></li>');
...
//alert(oneo+'two');
   $('.s1').append('<li><a href="http://fourthforce.in/verify/watchguardlive/uploads/'+oneo+'"><img src="http://fourthforce.in/verify/watchguardlive/uploads/'+one+'"  style="height: 300px;width:350px"></a></li>');

}
if ( k == 2){
  var oneoo=oneemploy[k];
//alert(oneoo+'3');
//$('.document_imag_inproone_notveria').append('<img src="http://fourthforce.in/verify/uploads/'+oneoo+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
   $('.s1').append('<li><a href="http://fourthforce.in/verify/watchguardlive/uploads/'+oneoo+'"><img src="http://fourthforce.in/verify/watchguardlive/uploads/'+one+'"  style="height: 300px;width:350px"></a></li>');

}
if ( k == 3){
  var oneooo=oneemploy[k];
// alert(oneooo+'4');
//$('.document_imag_inproone_notverid').append('<img src="http://fourthforce.in/verify/uploads/'+oneooo+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
   $('.s1').append('<li><a href="http://fourthforce.in/verify/watchguardlive/uploads/'+oneooo+'"><img src="http://fourthforce.in/verify/watchguardlive/uploads/'+one+'"  style="height: 300px;width:350px"></a></li>');

}
if ( k == 4){
  var oner=oneemploy[k];
// alert(oner+'5');
//$('.document_imag_inproone_notverie').append('<img src="http://fourthforce.in/verify/uploads/'+oner+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
   $('.s1').append('<li><a href="http://fourthforce.in/verify/watchguardlive/uploads/'+oner+'"><img src="http://fourthforce.in/verify/watchguardlive/uploads/'+one+'"  style="height: 300px;width:350px"></a></li>');
...
if ( k == 5){
  var oner=oneemploy[k];
// alert(oner+'6');
//$('.document_imag_inproone_notverif').append('<img src="http://fourthforce.in/verify/uploads/'+oner+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
   $('.s1').append('<li><a href="http://fourthforce.in/verify/watchguardlive/uploads/'+oner+'"><img src="http://fourthforce.in/verify/watchguardlive/uploads/'+one+'"  style="height: 300px;width:350px"></a></li>');
...
if ( j == 2){
  var oneo=oneemp[j];
//alert(oneoo+'3');
//$('.document_imag_inproone_notverib').append('<img src="http://fourthforce.in/verify/uploads/'+oneoo+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
   $('.s1').append('<li><a href="http://fourthforce.in/verify/watchguardlive/uploads/'+oneo+'"><img src="http://fourthforce.in/verify/watchguardlive/uploads/'+one+'"  style="height: 300px;width:350px"></a></li>');
...
if ( j == 3){
  var oneo=oneemp[j];
//alert(oneooo+'4');
//$('.document_imag_inproone_notveria').append('<img src="http://fourthforce.in/verify/uploads/'+oneooo+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
   $('.s1').append('<li><a href="http://fourthforce.in/verify/watchguardlive/uploads/'+oneo+'"><img src="http://fourthforce.in/verify/watchguardlive/uploads/'+one+'"  style="height: 300px;width:350px"></a></li>');
...
//alert(oneemp);
  $('.ssd').append('<li><a href="http://fourthforce.in/verify/watchguardlive/documents/addressid/'+oneemp+'"><img src="http://fourthforce.in/verify/watchguardlive/documents/addressid/'+oneemp+'" style="height: 100%;width:100%" ></a></li>');
...
if ( j == 0){
  ...
  //alert(one+'oneiiiiiiiiiiiiiiiiiiiiiiiiiii');
   $('.s1').append('<li><a href="http://fourthforce.in/verify/watchguardlive/documents/addressid/'+one+'"><img src="http://fourthforce.in/verify/watchguardlive/documents/addressid/'+one+'"  style="height: 300px;width:350px"></a></li>');
...
//alert(oneo+'two');
  $('.s1').append('<li><a href="http://fourthforce.in/verify/watchguardlive/documents/addressid/'+oneo+'"><img src="http://fourthforce.in/verify/watchguardlive/documents/addressid/'+one+'"  style="height: 300px;width:350px"></a></li>');

}
if ( j == 2){
  var oneoo=oneaddress[j];
//alert(oneoo+'3');
//$('.document_imag_inproone_notveria').append('<img src="http://fourthforce.in/verify/documents/addressid/'+oneoo+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
  $('.s1').append('<li><a href="http://fourthforce.in/verify/watchguardlive/documents/addressid/'+oneoo+'"><img src="http://fourthforce.in/verify/watchguardlive/documents/addressid/'+one+'"  style="height: 300px;width:350px"></a></li>');

}
if ( j == 3){
  var oneooo=oneaddress[j];
//alert(oneooo+'4');
//$('.document_imag_inproone_notverid').append('<img src="http://fourthforce.in/verify/documents/addressid/'+oneooo+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
  $('.s1').append('<li><a href="http://fourthforce.in/verify/watchguardlive/documents/addressid/'+oneooo+'"><img src="http://fourthforce.in/verify/watchguardlive/documents/addressid/'+one+'"  style="height: 300px;width:350px"></a></li>');

}
if ( j == 4){
  var oner=oneaddress[j];
// alert(oner+'5');
//$('.document_imag_inproone_notverie').append('<img src="http://fourthforce.in/verify/documents/addressid/'+oner+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
  $('.s1').append('<li><a href="http://fourthforce.in/verify/watchguardlive/documents/addressid/'+oner+'"><img src="http://fourthforce.in/verify/watchguardlive/documents/addressid/'+one+'"  style="height: 300px;width:350px"></a></li>');
...
if ( j == 5){
  var oner=oneaddress[j];
//alert(oner+'6');
//$('.document_imag_inproone_notverif').append('<img src="http://fourthforce.in/verify/documents/addressid/'+oner+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
  $('.s1').append('<li><a href="http://fourthforce.in/verify/watchguardlive/documents/addressid/'+oner+'"><img src="http://fourthforce.in/verify/watchguardlive/documents/addressid/'+one+'"  style="height: 300px;width:350px"></a></li>');
...
$.ajax({url: "http://fourthforce.in/verify/slim-cor/supervisor_status_to_inprogress.php?status_val="+status_val+"&verification_user_id="+verification_user_id+"&remark="+remark+"&qualification_id="+qualification_id+"&region_num="+region_num,
