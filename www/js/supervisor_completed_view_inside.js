...
// /alert(oneemp);
  $('.s22').append('<li><a href="http://fourthforce.in/verify/watchguardlive/uploads/'+oneemp+'"><img src="http://fourthforce.in/verify/watchguardlive/uploads/'+oneemp+'" style="height: 100%;width:100%" ></a></li>');
  ...
  $('.s22').append('<li><a href="http://fourthforce.in/verify/watchguardlive/uploads/'+oneemp+'"><img src="http://fourthforce.in/verify/watchguardlive/uploads/'+oneemp+'" style="height: 100%;width:100%" ></a></li>');
     ...
     $('.s2').append('<li><a href="http://fourthforce.in/verify/watchguardlive/uploads/'+one+'"><img src="http://fourthforce.in/verify/watchguardlive/uploads/'+one+'" style="height: 100%;width:100%" ></a></li>');
      ...
      if (k == 1 ){
        ...
        //alert(oneo+'two');
     $('.s2').append('<li><a href="http://fourthforce.in/verify/watchguardlive/uploads/'+oneo+'"><img src="http://fourthforce.in/verify/watchguardlive/uploads/'+oneo+'" style="height: 100%;width:100%" ></a></li>');

      }
      if (k == 2 ){
        var oneo=oneemploy[k];
        //alert(oneo+'two');
        //$('.document_imag_inproone_verib_c').append('<img src="http://fourthforce.in/verify/uploads/'+oneo+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
 $('.s2').append('<li><a href="http://fourthforce.in/verify/watchguardlive/uploads/'+oneo+'"><img src="http://fourthforce.in/verify/watchguardlive/uploads/'+oneo+'" style="height: 100%;width:100%" ></a></li>');
      ...
      if (k == 3 ){
        var oneo=oneemploy[k];
        //alert(oneo+'two');
       // $('.document_imag_inproone_veria_c').append('<img src="http://fourthforce.in/verify/uploads/'+oneo+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
 $('.s2').append('<li><a href="http://fourthforce.in/verify/watchguardlive/uploads/'+oneo+'"><img src="http://fourthforce.in/verify/watchguardlive/uploads/'+oneo+'" style="height: 100%;width:100%" ></a></li>');
      ...
      if (k == 4 ){
        var oneo=oneemploy[k];
        //alert(oneo+'two');
       // $('.document_imag_inproone_verie_c').append('<img src="http://fourthforce.in/verify/uploads/'+oneo+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
 $('.s2').append('<li><a href="http://fourthforce.in/verify/watchguardlive/uploads/'+oneo+'"><img src="http://fourthforce.in/verify/watchguardlive/uploads/'+oneo+'" style="height: 100%;width:100%" ></a></li>');
      ...
      if (k == 5 ){
        var oneo=oneemploy[k];
       // alert(oneo+'two');
      //  $('.document_imag_inproone_verif_c').append('<img src="http://fourthforce.in/verify/uploads/'+oneo+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
 $('.s2').append('<li><a href="http://fourthforce.in/verify/watchguardlive/uploads/'+oneo+'"><img src="http://fourthforce.in/verify/watchguardlive/uploads/'+oneo+'" style="height: 100%;width:100%" ></a></li>');
...
if (j == 3 ){
  var oneo=oneemp[j];
  //alert(oneo+'two');
  //$('.document_imag_inproone_verid_c').append('<img src="http://fourthforce.in/verify/uploads/'+oneo+'" alt="Band"  class="rondell-item-image rondell-item-resizeable">');
 $('.s2').append('<li><a href="http://fourthforce.in/verify/watchguardlive/uploads/'+oneo+'"><img src="http://fourthforce.in/verify/watchguardlive/uploads/'+oneo+'" style="height: 100%;width:100%" ></a></li>');
...
//alert(oneemp);
  $('.s22').append('<li><a href="http://fourthforce.in/verify/watchguardlive/documents/addressid/'+oneemp+'"><img src="http://fourthforce.in/verify/watchguardlive/documents/addressid/'+oneemp+'" style="height: 100%;width:100%" ></a></li>');
...
if (j == 0 ){
  ...
  //$('.document_imag_inproone_veric_c').append('<img src="http://fourthforce.in/verify/documents/addressid/'+one+'" alt="Band" title="My favourite band" class="rondell-item-image rondell-item-resizeable">');
  
  $('.s2').append('<li><a href="http://fourthforce.in/verify/watchguardlive/documents/addressid/'+one+'"><img src="http://fourthforce.in/verify/watchguardlive/documents/addressid/'+one+'"  style="height: 100%;width:100%"></a></li>');
...
if (j == 1 ){
  ...
  //alert(oneo+'two');
  $('.s2').append('<li><a href="http://fourthforce.in/verify/watchguardlive/documents/addressid/'+oneo+'"><img src="http://fourthforce.in/verify/watchguardlive/documents/addressid/'+oneo+'"  style="height: 100%;width:100%"></a></li>');

}
if (j == 2 ){
  var oneo=oneaddress[j];
 // alert(oneo+'two');
  $('.document_imag_inproone_verib_c').append('<img src="http://fourthforce.in/verify/documents/addressid/'+oneo+'" alt="Band" title="My favourite band" class="rondell-item-image rondell-item-resizeable">');
...
if (j == 3 ){
  var oneo=oneaddress[j];
 // alert(oneo+'two');
  $('.document_imag_inproone_veria_c').append('<img src="http://fourthforce.in/verify/documents/addressid/'+oneo+'" alt="Band" title="My favourite band" class="rondell-item-image rondell-item-resizeable">');
...
if (j == 4 ){
  var oneo=oneaddress[j];
 // alert(oneo+'two');
  $('.document_imag_inproone_verie_c').append('<img src="http://fourthforce.in/verify/documents/addressid/'+oneo+'" alt="Band" title="My favourite band" class="rondell-item-image rondell-item-resizeable">');
...
//$('.document_imag_veri').append('<img class="profile-thumbnail" src="http://fourthforce.in/verify/documents/addressid/'+oneproof+'" style="width:150px;height:150px">&nbsp');
