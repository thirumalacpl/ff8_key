...
// /alert(oneemp);
  $('.sddq').append('<li><a href="http://fourthforce.in/verify/watchguardlive/uploads/'+oneemp+'"><img src="http://fourthforce.in/verify/watchguardlive/uploads/'+oneemp+'" style="height: 100%;width:100%" ></a></li>');
...
if (j == 0 ){
  var one=oneemp[j];
//alert(one+'oneemp');
//$('.document_imag_inprooneqc').append('<img src="http://fourthforce.in/verify/uploads/'+one+'" alt="Band" title="My favourite band" class="rondell-item-image rondell-item-resizeable">');
 $('.s').append('<li><a href="http://fourthforce.in/verify/watchguardlive/uploads/'+one+'"><img src="http://fourthforce.in/verify/watchguardlive/uploads/'+one+'"  style="height: 300px;width:350px"></a></li>');
...
if (j == 1 ){
  var oneo=oneemp[j];
// alert(oneo+'two');
//$('.document_imag_inprooneqd').append('<img src="http://fourthforce.in/verify/uploads/'+oneo+'" alt="Band" title="My favourite band" class="rondell-item-image rondell-item-resizeable">');
 $('.s').append('<li><a href="http://fourthforce.in/verify/watchguardlive/uploads/'+oneo+'"><img src="http://fourthforce.in/verify/watchguardlive/uploads/'+oneo+'"  style="height: 300px;width:350px"></a></li>');

}
if (j == 2 ){
  var oneo=oneemp[j];
//alert(oneo+'two');
//$('.document_imag_inprooneqb').append('<img src="http://fourthforce.in/verify/uploads/'+oneo+'" alt="Band" title="My favourite band" class="rondell-item-image rondell-item-resizeable">');
 $('.s').append('<li><a href="http://fourthforce.in/verify/watchguardlive/uploads/'+oneo+'"><img src="http://fourthforce.in/verify/watchguardlive/uploads/'+oneo+'"  style="height: 300px;width:350px"></a></li>');
...
if (j == 3 ){
  var oneo=oneemp[j];
// alert(oneo+'two');
//$('.document_imag_inprooneqa').append('<img src="http://fourthforce.in/verify/uploads/'+oneo+'" alt="Band" title="My favourite band" class="rondell-item-image rondell-item-resizeable">');
 $('.s').append('<li><a href="http://fourthforce.in/verify/watchguardlive/uploads/'+oneo+'"><img src="http://fourthforce.in/verify/watchguardlive/uploads/'+oneo+'"  style="height: 300px;width:350px"></a></li>');
...
if (j == 4 ){
  var oneo=oneemp[j];
//alert(oneo+'two');
//$('.document_imag_inprooneqe').append('<img src="http://fourthforce.in/verify/uploads/'+oneo+'" alt="Band" title="My favourite band" class="rondell-item-image rondell-item-resizeable">');
 $('.s').append('<li><a href="http://fourthforce.in/verify/watchguardlive/uploads/'+oneo+'"><img src="http://fourthforce.in/verify/watchguardlive/uploads/'+oneo+'"  style="height: 300px;width:350px"></a></li>');
...
if (j == 5 ){
  var oneo=oneemp[j];
//alert(oneo+'two');
//$('.document_imag_inprooneqf').append('<img src="http://fourthforce.in/verify/uploads/'+oneo+'" alt="Band" title="My favourite band" class="rondell-item-image rondell-item-resizeable">');
 $('.s').append('<li><a href="http://fourthforce.in/verify/watchguardlive/uploads/'+oneo+'"><img src="http://fourthforce.in/verify/watchguardlive/uploads/'+oneo+'"  style="height: 300px;width:350px"></a></li>');
...
//alert(oneemp);
  $('.sddq').append('<li><a href="http://fourthforce.in/verify/watchguardlive/documents/addressid/'+oneemp+'"><img src="http://fourthforce.in/verify/watchguardlive/documents/addressid/'+oneemp+'" style="height: 100%;width:100%" ></a></li>');
...
//alert(one+'oneemp');
//$('.document_imag_inprooneqc').append('<img src="http://fourthforce.in/verify/documents/addressid/'+one+'" alt="Band" title="My favourite band" class="rondell-item-image rondell-item-resizeable">');
$('.s').append('<li><a href="http://fourthforce.in/verify/watchguardlive/documents/addressid/'+one+'"><img src="http://fourthforce.in/verify/watchguardlive/documents/addressid/'+one+'"  style="height: 300px;width:350px"></a></li>');
...
//alert(oneo+'two');
//$('.document_imag_inprooneqd').append('<img src="http://fourthforce.in/verify/documents/addressid/'+oneo+'" alt="Band" title="My favourite band" class="rondell-item-image rondell-item-resizeable">');
$('.s').append('<li><a href="http://fourthforce.in/verify/watchguardlive/documents/addressid/'+oneo+'"><img src="http://fourthforce.in/verify/watchguardlive/documents/addressid/'+oneo+'"  style="height: 300px;width:350px"></a></li>');

}
if (j == 2 ){
  var oneo=oneaddress[j];
// alert(oneo+'two');
$('.document_imag_inprooneqb').append('<img src="http://fourthforce.in/verify/documents/addressid/'+oneo+'" alt="Band" title="My favourite band" class="rondell-item-image rondell-item-resizeable">');

}
if (j == 3 ){
  var oneo=oneaddress[j];
// alert(oneo+'two');
$('.document_imag_inprooneqa').append('<img src="http://fourthforce.in/verify/documents/addressid/'+oneo+'" alt="Band" title="My favourite band" class="rondell-item-image rondell-item-resizeable">');

}
if (j == 4 ){
  var oneo=oneaddress[j];
// alert(oneo+'two');
$('.document_imag_inprooneqe').append('<img src="http://fourthforce.in/verify/documents/addressid/'+oneo+'" alt="Band" title="My favourite band" class="rondell-item-image rondell-item-resizeable">');

}
if (j == 5 ){
  var oneo=oneaddress[j];
// alert(oneo+'two');
$('.document_imag_inprooneqf').append('<img src="http://fourthforce.in/verify/documents/addressid/'+oneo+'" alt="Band" title="My favourite band" class="rondell-item-image rondell-item-resizeable">');
...
$.ajax({url: "http://fourthforce.in/verify/slim-cor/supervisor_status_to_verified.php?status_val_inpro="+status_val_inpro+"&verification_user_id="+verification_user_id+"&remark_inpro="+remark_inpro+"&coordinator_id="+coordinator_id+"&region_num="+region_num+"&activity_log="+activity_log+"&sdocument="+sdocument,
