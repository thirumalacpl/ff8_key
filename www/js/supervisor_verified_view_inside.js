...
// /alert(oneemp);
  $('.sdd').append('<li><a href="http://fourthforce.in/verify/watchguardlive/uploads/'+oneemp+'"><img src="http://fourthforce.in/verify/watchguardlive/uploads/'+oneemp+'" style="height: 100%;width:100%" ></a></li>');
...
//  $('.document_imag_veri').append('<img class="profile-thumbnail" src="http://fourthforce.in/verify/uploads/'+oneemp+'" style="width:150px;height:150px">&nbsp;');
...
//alert(oneemp);
  $('.sdd').append('<li><a href="http://fourthforce.in/verify/watchguardlive/documents/addressid/'+oneemp+'"><img src="http://fourthforce.in/verify/watchguardlive/documents/addressid/'+oneemp+'" style="height: 100%;width:100%" ></a></li>');
