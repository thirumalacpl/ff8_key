...
$.ajax({
  type: "POST",
  url: "http://fourthforce.in/verify/slim-cor/chat_cor.php?loginistant="+loginistant+"&verification_user_id="+verification_user_id+"&qualification_id="+qualification_id,
